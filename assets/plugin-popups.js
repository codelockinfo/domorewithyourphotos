...
NodeList.prototype.semanticPopup = function () {
	...
	for (var i = 0; i < this.length; i++) {
		...
		element.querySelectorAll('.close, button[type="reset"]').forEach(el => {
...
function openPopup(dataPopupAttributeValue) {
	new_css('css-popups', '//cdn.shopify.com/s/files/1/0099/8693/2814/t/37/assets/async-popups.css?v=17526083895671418351691157451');
